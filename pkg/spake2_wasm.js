...
*/
module.exports.start = function(id, password) {
...
* @returns {Uint8Array}
*/
module.exports.msg = function(wrapper) {
...
* @returns {Uint8Array}
*/
module.exports.finish = function(wrapper, inbound) {
    _assertClass(wrapper, GroupWrapper);
...
module.exports.GroupWrapper = GroupWrapper;
